...
class ReadFileChunkLoadingRuntimeModule extends RuntimeModule {
  ...
  generate() {
    ...
    const outputName = this.compilation.getPath(
      (
        (webpack && webpack.javascript.JavascriptModulesPlugin.getChunkFilenameTemplate) || require("webpack/lib/javascript/JavascriptModulesPlugin").getChunkFilenameTemplate
                  ...
                  Template.indent([
                    ...
                    Template.indent([
                      ...
                      Template.indent([
                        ...
                        '}',
                        `var requestedRemote = global.REMOTE_CONFIG[${JSON.stringify(name)}]`,
