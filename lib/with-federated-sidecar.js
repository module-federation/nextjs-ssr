  ...
  (nextConfig = {}) => {
    ...
    return Object.assign({}, nextConfig, {
      ...
      webpack(config, options) {
        ...
        federationPluginOptions.remotes = Object.entries(
          federationPluginOptions.remotes
        ).reduce((acc, [key, remote]) => {
          acc[key] = addQueryToRemote(remote);
          return acc;
        }, {});
        if (options.isServer) {
    ...
    script.onload = function(){
      if(!window.${moduleName}.__initialized) {
          Promise.resolve(window.${moduleName}.init(${
